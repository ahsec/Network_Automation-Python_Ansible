...
def get_out(dev_conn, command):
    '''
    Runs a command in enable mode using the earista eAPI and returns the data relavant to the
    switch output.
...
def main():
    '''
    Establishes connection and unpacks output to retrieve relevant in and out Octects data
    '''
